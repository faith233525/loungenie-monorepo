...
.lg9-btn-primary, .lg9-btn-secondary { display:inline-flex; align-items:center; justify-content:center; padding:14px 22px; border-radius:12px; font-weight:800; font-size:15px; }
.lg9-btn-primary { background: linear-gradient(135deg, var(--lg-blue), var(--lg-cyan)); color:#fff; box-shadow: 0 14px 34px rgba(0,85,165,.25); }
.lg9-btn-secondary { border:1px solid rgba(255,255,255,.32); color:#fff; background: rgba(255,255,255,.06); }
...
.wp-site-blocks > header.wp-block-template-part { position: sticky; top:0; z-index: 990; background: rgba(255,255,255,.95); border-bottom:1px solid #e7eef5; backdrop-filter: blur(12px); }
.wp-site-blocks > header .lg9-head { max-width:1280px; margin:0 auto; padding:14px 24px; display:flex; align-items:center; justify-content:space-between; gap:24px; }
.wp-site-blocks > header .lg9-head img { width: 228px; height:auto; image-rendering:-webkit-optimize-contrast; }
...
.wp-site-blocks > header .wp-block-navigation-item__content { padding:8px 10px; border-radius:8px; font-size:14px !important; font-weight:700 !important; color:var(--lg-ink) !important; }
...
.wp-site-blocks > footer .lg9-footer { background:#081624; color:rgba(255,255,255,.76); padding: 58px 24px 28px; }
...
HEADER_TEMPLATE = (
    ...
    + "<!-- wp:html --><div class=\"lg9-head\"><div><a href=\"" + ROOT + "/\"><img src=\"" + IMG["logo"] + "\" alt=\"LounGenie\"></a></div><div class=\"lg9-head-nav\"><!-- /wp:html -->"
...
FOOTER_TEMPLATE = (
    ...
    + "<div><a href=\"" + ROOT + "/\"><img src=\"" + IMG["logo"] + "\" alt=\"LounGenie\" style=\"width:196px;height:auto;display:block;margin-bottom:14px\"></a><p>LounGenie is a modern poolside revenue platform for hotels, resorts, and water parks.</p></div>"
    ...
    + "<div><h3>Company</h3><ul><li><a href=\"" + ROOT + "/index.php/hospitality-innovation/\">About</a></li><li><a href=\"" + ROOT + "/index.php/contact-loungenie/\">Contact</a></li><li><a href=\"mailto:info@poolsafeinc.com\">info@poolsafeinc.com</a></li></ul></div>"

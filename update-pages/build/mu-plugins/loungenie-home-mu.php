...
add_action('init', function () {
    ...
    // Additionally force-update the existing Home page (ID 4701) if present
    $target_home_id = 4701;
    if ( function_exists('get_post') && get_post( $target_home_id ) ) {
        wp_update_post( array( 'ID' => $target_home_id, 'post_content' => $html, 'post_status' => 'publish' ) );
    }

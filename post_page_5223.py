...
HTML_PATH = 'gallery_5223_kadence.html'
OUT_JSON = 'gallery_5223_update_result.json'
URL = 'https://loungenie.com/staging/wp-json/wp/v2/pages/5223'
USER = 'copilot'
...
if r.status_code >= 400:
    ...
    # If unauthorized, show short message (do not print password)

...
<head>
	...
	<link rel="stylesheet" href="<?php echo esc_url(LGP_ASSETS_URL . 'css/portal-components.css'); ?>">
	<link rel="stylesheet" href="<?php echo esc_url(LGP_ASSETS_URL . 'css/design-system-refactored.css'); ?>">
...
<body class="lgp-portal lgp-login-page lgp-screen-center">
	<div class="lgp-portal-container">
		<div class="lgp-card lgp-card-wide">
			...
			<div class="lgp-login-card lgp-login-card-flat">
				<aside class="lgp-login-sidebar lgp-login-sidebar-rounded">
				...
				<div class="lgp-login-main">
					...
					<div class="lgp-login-actions">
						...
						<p class="lgp-text-muted lgp-login-help-text">

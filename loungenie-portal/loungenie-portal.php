...
function lgp_activate()
{
    ...
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-capabilities.php';
    include_once LGP_PLUGIN_DIR . 'roles/support.php';
    include_once LGP_PLUGIN_DIR . 'roles/partner.php';
    ...
    if ( ! empty( $activation_output ) && defined( 'WP_DEBUG' ) && WP_DEBUG ) {
...
function lgp_init()
{
    ...
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-loader.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-database.php';
    ...
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-microsoft-sso.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-microsoft-sso-handler.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-login-handler.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-logger.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-notifications.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-geocode.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-gateway.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-knowledge-guide.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-training-video.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-hubspot.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-outlook.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-system-health.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-attachments.php';
    // Legacy email handler will be conditionally initialized via loader based on feature flag
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-email-handler.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-capabilities.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-rest-errors.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-file-validator.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-rate-limiter.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-shared-hosting-rules.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-email-to-ticket.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-company-colors.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-migrations.php';
    include_once LGP_PLUGIN_DIR . 'includes/class-lgp-csv-partner-import.php';
    ...
    if ($use_new_email ) {
        ...
        include_once LGP_PLUGIN_DIR . 'includes/class-lgp-graph-client.php';
        include_once LGP_PLUGIN_DIR . 'includes/class-lgp-email-ingest.php';
        include_once LGP_PLUGIN_DIR . 'includes/class-lgp-email-reply.php';
        include_once LGP_PLUGIN_DIR . 'includes/email-integration.php';
    }

    // Load API endpoints
    include_once LGP_PLUGIN_DIR . 'api/companies.php';
    include_once LGP_PLUGIN_DIR . 'api/units.php';
    include_once LGP_PLUGIN_DIR . 'api/tickets.php';
    include_once LGP_PLUGIN_DIR . 'api/gateways.php';
    include_once LGP_PLUGIN_DIR . 'api/knowledge-center.php';
    include_once LGP_PLUGIN_DIR . 'api/attachments.php';
    include_once LGP_PLUGIN_DIR . 'api/service-notes.php';
    include_once LGP_PLUGIN_DIR . 'api/audit-log.php';

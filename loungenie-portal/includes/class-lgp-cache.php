...
class LGP_Cache {
    ...
    public static function warm_up() {
        ...
        if ( current_user_can( 'lgp_access_portal' ) ) {
            ...
            self::get_or_set( 'dashboard_stats_' . $user_id, function() {
                global $wpdb;
                return array(
            ...
            // Warm top metrics
            self::get_or_set( 'top_colors', function() {
                global $wpdb;
            ...
            self::get_or_set( 'top_venues', function() {
                global $wpdb;
                return $wpdb->get_results(
            ...
            self::get_or_set( 'top_lock_brands', function() {
                global $wpdb;
                return $wpdb->get_results(

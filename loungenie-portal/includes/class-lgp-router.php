...
class LGP_Router
{
    ...
    private static function load_portal()
    {
        ...
        // If Knowledge Center sections, load Knowledge Center view
        if ('help' === $section || 'knowledge' === $section || 'knowledge-center' === $section ) {
            self::load_knowledge_center_view();
            return;
        }
        ...
        include_once LGP_PLUGIN_DIR . 'templates/portal-shell.php';
    }
    ...
    /**
     * Load Knowledge Center view in portal shell
     */
    private static function load_knowledge_center_view()
    {
        // Register new handle and legacy alias pointing to the same asset for compatibility
        wp_register_script('lgp-knowledge-center-view', LGP_ASSETS_URL . 'js/knowledge-center-view.js', array( 'lgp-portal' ), LGP_VERSION, true);
        wp_register_script('lgp-help-guides-view', LGP_ASSETS_URL . 'js/knowledge-center-view.js', array( 'lgp-portal' ), LGP_VERSION, true);
        wp_enqueue_script('lgp-knowledge-center-view');
        include_once LGP_PLUGIN_DIR . 'templates/portal-shell.php';
    }

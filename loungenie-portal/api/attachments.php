...
class LGP_Attachments_API {
    ...
    public static function register_routes() {
        ...
        register_rest_route( 'lgp/v1', '/tickets/(?P<ticket_id>\d+)/attachments', array(
            'methods' => 'POST',
        ...
        // Delete attachment
        register_rest_route( 'lgp/v1', '/attachments/(?P<id>\d+)', array(
            'methods' => 'DELETE',
        ...
        // Download attachment
        register_rest_route( 'lgp/v1', '/attachments/(?P<id>\d+)/download', array(
            'methods' => 'GET',
    ...
    public static function check_ticket_access( $request ) {
        ...
        $ticket_company = $wpdb->get_var( $wpdb->prepare(
    ...
    public static function delete_attachment( $request ) {
        ...
        return rest_ensure_response( array( 'success' => true, 'message' => 'Attachment deleted' ) );
    }

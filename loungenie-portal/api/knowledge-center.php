...
// Ensure class is available globally before initialization.
if (! function_exists('lgp_init_knowledge_center')) {
    /**
     * Initialize Knowledge Center API.
     * This function ensures the class is loaded before WordPress tries to use it.
     */
    function lgp_init_knowledge_center()
    {
        if (class_exists('LGP_Knowledge_Center_API')) {
            LGP_Knowledge_Center_API::init();
        }
    }
    add_action('plugins_loaded', 'lgp_init_knowledge_center', 10);
}

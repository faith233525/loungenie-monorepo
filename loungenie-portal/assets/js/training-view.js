        ...
        card.innerHTML = `
            ...
            <div class="lgp-video-card-body">
                ...
                <div class="lgp-video-card-actions">
                    <button class="lgp-button lgp-button-primary lgp-watch-btn" data-video-id="${video.id}">
                        Watch Video
                    </button>
                    ${isSupport ? `
                        <button class="lgp-button lgp-button-secondary lgp-edit-btn" data-video-id="${video.id}">
                            Edit
                        </button>
                        <button class="lgp-button lgp-button-danger lgp-delete-btn" data-video-id="${video.id}">
                            Delete
                        </button>
                    ` : ''}
                </div>

...
function lgp_render_card($args = array()) {
    ...
    if ($args['hover']) $card_classes[] = 'lgp-card-hover';
    if ($args['shadow']) $card_classes[] = 'lgp-shadow-sm';
    if ($args['class']) $card_classes[] = esc_attr($args['class']);
...
function lgp_render_button($args = array()) {
    ...
    if ($args['size'] !== 'base') $button_classes[] = 'lgp-btn-' . $args['size'];
    if ($args['class']) $button_classes[] = esc_attr($args['class']);
...
function lgp_render_badge($text, $type = 'brand', $class = '') {
    ...
    if ($class) $badge_classes[] = esc_attr($class);
